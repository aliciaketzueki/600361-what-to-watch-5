...
const Main = (props) => {
  // В компоненте главной страницы приложения определите изменяемые данные — это будет название, жанр и дата выхода промо-фильма (того, что в шапке страницы). Получите их из props и вставьте в JSX компонента.
